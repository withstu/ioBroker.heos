...
class HeosPlayer {
	...
	timeSeek(seconds){
		...
		let data = `<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/" s:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/">
						<s:Body>
		...
		const options = {
			hostname: this.ip,
			port: 60006,
			path: '/upnp/control/renderer_dvc/AVTransport',
			method: 'POST',
			timeout: 1000,
			headers: {
